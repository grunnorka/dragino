...
ThingsBoard profile with vakt.systemat.is hostname and DNS 1.1.1.1, then reboots with ATZ.
"""
...
APN = "internet"
SERVADDR = "vakt.systemat.is,1883"
BKDNS = "1,0"  # Disable dynamic DNS updates, no fallback IP (rely on DNS resolution)
...
def main() -> int:
    ...
    print("\n=== Applying Síminn + vakt.systemat.is config (DNS 1.1.1.1) ===")
    ...
    print("\nConfig saved. The device will reboot and reconnect with Síminn + vakt.systemat.is (DNS 1.1.1.1).")
    ser.close()
    return 0
