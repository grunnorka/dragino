#!/usr/bin/env python3
"""Partial factory reset (AT+FDR1) and reconfigure Síminn PS-CB-NA for vakt.systemat.is.
...
def main() -> int:
    ...
    print(f"Port={args.port} FDR1 + reconfigure for vakt.systemat.is (Síminn)", flush=True)
